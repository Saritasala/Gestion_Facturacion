...
<div class="table-responsive">
	<table id="userList" class="table align-items-center table-bordered table-hover table-striped">
		...
		<tr>
			...
			<td>
				<a class="btn btn-sm btn-warning" href="{{route('home')}}"><i class="fas fa-edit"></i> Editar</a>
                <button class="btn btn-sm btn-danger btnDeleteCommerces"><i class="fas fa-trash-alt"></i> Eliminar</button>
			</td>
		</tr>
		</tbody>
	</table>
